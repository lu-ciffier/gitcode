 ...
 * 处理实时数据请求Action
 * **/
public class RealDataAction implements PortDataListener{
	private String data;
	 ...
	 * 获取网络拓扑
	 */
	public void getTopology(String point){
	...
	public void getPortData(String sb) {
		this.portData.append(sb);
		//System.out.println("推送的最新数据："+portData);
	}
}
